...
parser.add_argument("--output-dir", type=str, default=DEFAULT_OUTPUT_DIR, help="output directory where to put downloaded models")
parser.add_argument("--all", default=False, action="store_true", help="download all available models")
...
for net in download_nets:
    ...
    sys.stdout.flush()
    urllib.request.urlretrieve(MODELS_DIR_URL + net + "." + SUFFIX, os.path.join(args.output_dir, "%s.%s"%(net, SUFFIX)))
    print("Done")
